...
Note: Google Gemini support has been removed
"""

from langchain_core.language_models import BaseChatModel
from langchain_openai import ChatOpenAI, AzureChatOpenAI
from langchain_anthropic import ChatAnthropic
# Google Gemini support removed - langchain_google_genai import commented out
...
class LLMProvider(str, Enum):
    ...
    AZURE_OPENAI = "azure"
    ANTHROPIC = "anthropic"
    # GEMINI = "gemini"  # Google Gemini support removed
    OLLAMA = "ollama"
...
class LLMFactory:
    ...
    def _create_openai(
        ...
        **kwargs
        ...
        # Custom base URL (Azure-compatible endpoint, proxy, or China gateway)
        openai_base_url = os.getenv("OPENAI_BASE_URL") or kwargs.pop("base_url", None)
        if openai_base_url:
            llm_kwargs["base_url"] = openai_base_url.rstrip("/")
    ...
    def _create_azure_openai(
        ...
        **kwargs
        ...
        # Required Azure parameters (endpoint: AZURE_OPENAI_ENDPOINT or fallback OPENAI_BASE_URL)
        azure_endpoint = (
            os.getenv("AZURE_OPENAI_ENDPOINT") or os.getenv("OPENAI_BASE_URL") or ""
        ).strip().rstrip("/")
        ...
        if not azure_endpoint:
            raise ValueError(
                "Azure OpenAI requires an endpoint. Set AZURE_OPENAI_ENDPOINT or OPENAI_BASE_URL. "
    ...
    # Google Gemini support removed - _create_gemini method commented out
    # @staticmethod
    # def _create_gemini(
    #     model: str = None,
    #     temperature: float = 0.3,
...
Example 4: Using Google Gemini (REMOVED - Google services disabled)
------------------------------------------------------------------
# Google Gemini support has been removed from the application
